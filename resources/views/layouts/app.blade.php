  ...
  <div class="container-fluid no-padding">
    <footer>
      <div class="app-footer col-xs-12">
        ...
        <div class="col-xs-4"></div>
        <div class="col-xs-4 powered-by-urcorp text-right vertical-middle">
          <h3 class="inline-block"> 
            Powered by  
          </h3>
          <a href="http://urcorp.mx/" target="__blank" title="UrCorp - Logotipo">
            <div class="logo-urcorp inline-block vertical-middle"></div>
          </a>
        </div>
      </div>
    </footer>
